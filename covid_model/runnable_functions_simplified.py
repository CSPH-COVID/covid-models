...
""" Local Imports """
from covid_model import CovidModelSimplified
...
def __single_batch_fit(model: CovidModelSimplified, tc_min, tc_max, yd_start=None, tstart=None, tend=None, regions=None):
...
def do_single_fit(tc_0=0.75,
                  ...
                  model_class=CovidModelSimplified,
                  **model_args):
    ...
    Args:
        ...
        model_class: What class to use for the CovidModelSimplified. Useful if using different versions of the model (with more or fewer compartments, say)
...
def do_build_legacy_output_df(model: CovidModelSimplified):
