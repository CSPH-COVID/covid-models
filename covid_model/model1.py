...
class CovidModel:
    ...
    def start_date(self, value):
        ...
        # TO DO: hackish: redo tc so it's a sorted dict I think.
    ...
    def re_estimates(self):
        # TO DO: quick fix, assumes gamm is constant
            ...
            # Transmission parameters attached to the transmission location
                ...
                for from_region in self.attrs['region']:
                    for in_region in self.attrs['region']:
                        ...
                        for to_region in self.attrs['region']:
                            # TO DO: take advantage of from_coef and to_coef to more efficiently store mobility parameters
                            # TO DO: update with immune escape
    ...
    def to_json_string(self):
        ...
        #TO DO: handle mobility, add in proj_mobility
