...
def main():
    ...
    subdir = "20220506_co_omicron_ba2.12.1_scenarios"
    ...
    specs_args = {
        ...
        'attribute_multipliers': f'covid_model/input/{subdir}/20220506_attribute_multipliers.json',
