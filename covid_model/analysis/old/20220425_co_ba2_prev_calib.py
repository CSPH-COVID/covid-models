...
def main():
    ...
    scen_args = {
        ...
        'refit_from_date': dt.datetime.strptime('2021-12-07', "%Y-%m-%d").date()
    }
    ...
    [run_compartment_report(from_date, to_date, group_by_attr_names=['age', 'vacc', 'priorinf', 'immun', 'seir', 'variant'], model=m, outdir=outdir, fname_extra=scen) for scen, m in ms.items()]
