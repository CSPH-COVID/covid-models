...
def main():
    ...
    dfnew = pd.read_csv(f"{os.path.join('covid_model', 'output', results_dir, '')}20220519_145237_run_model_scenarios_hospitalized2_.csv")
    ...
    # new version
    df_legacy2 = pd.read_csv(os.path.join('covid_model', 'output', results_dir, "20220519_145237_out2_.csv"))
    ...
    shutil.copy2(os.path.join('covid_model', 'output', results_dir, '20220519_135003_omicron_report_5_percent_0_0_0.png'), get_filepath_prefix(outdir) + '_omicron_report_high_new.png')
    shutil.copy2(os.path.join('covid_model', 'output', results_dir, '20220519_141650_omicron_report_5_percent_1_0_0.png'), get_filepath_prefix(outdir) + '_omicron_report_low_new.png')
