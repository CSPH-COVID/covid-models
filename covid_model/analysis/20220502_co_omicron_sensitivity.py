...
def main():
    ...
    subdir = "20220502_co_omicron_sensitivity"
    ...
    specs_args = {
        ...
        'attribute_multipliers': f'covid_model/input/{subdir}/attribute_multipliers.json',
    ...
    scen_args = {
        ...
        'attribute_multipliers_scens': f'covid_model/input/{subdir}/attribute_multipliers_scenarios.json',
        'refit_from_date': dt.datetime.strptime('2021-11-13', "%Y-%m-%d").date(),
        'multiprocess': 4,
