...
def main():
    ...
    subdir = "20220505_co_omicron_ba2.12.1_scenarios"
    ...
    specs_args = {
        ...
        'attribute_multipliers': f'covid_model/input/{subdir}/20220505_attribute_multipliers.json',
    ...
    scen_args = {
        'params_scens': f'covid_model/input/{subdir}/params_scens_ba2.12.1.json',
        #'params_scens': None,
        ...
        #'attribute_multipliers_scens': f'covid_model/input/{subdir}/attribute_multipliers_om_seed.json',
