...
if __name__ == "__main__":
    ...
    #                           multiprocess=3)
    #
    # for reg, model in zip(regions_to_use, models):
    ...
    model_args = {
        'base_spec_id': 4330,  # model.spec_id, # use the spec id that was output from the model fit
        'regions':['con']
    }
    model_fit_args = {
        'outdir': outdir,
